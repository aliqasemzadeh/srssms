...
new class extends Component
{
    ...
    #[On('panels.administrator.support-system.ticket.index.refresh')]
...
<div>
    <x-slot name="title">{{ __('general.all_tickets') }} - {{ config('app.name') }}</x-slot>
    ...
    <div class="space-y-6">
        <div class="flex flex-wrap items-center justify-between gap-3">
            <flux:breadcrumbs>
                ...
                <flux:breadcrumbs.item>{{ __('general.all_tickets') }}</flux:breadcrumbs.item>
            </flux:breadcrumbs>
        </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <flux:dropdown align="end" class="shrink-0 ms-auto">
                    ...
                    <flux:popover class="w-[min(100vw-2rem,20rem)] max-h-[70vh] overflow-y-auto flex flex-col gap-4">
                        <flux:select wire:model.live="status" variant="listbox" searchable placeholder="{{ __('general.ticket_status') }}..." clearable>
