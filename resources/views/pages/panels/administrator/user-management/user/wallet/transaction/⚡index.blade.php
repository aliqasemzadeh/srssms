...
<div>
    ...
    <div class="space-y-6">
        <div class="flex flex-wrap items-center justify-between gap-3">
            ...
            @can('finance-management.transaction.create')
            <div class="sm:hidden shrink-0">
                <flux:dropdown align="end">
                    ...
                    <flux:menu>
                        <flux:menu.item
                            icon="plus"
                            wire:click="$dispatch('panels.administrator.user-management.user.wallet.transaction.create.assign-data')"
                        >
                        ...
                        <flux:table.row :key="$transaction->id">
                            ...
                            <flux:table.cell align="end">
                                <div class="flex justify-end gap-2">
                                    @can('finance-management.transaction.edit')
                                    ...
                                    @endcan
                                    @can('finance-management.transaction.delete')
