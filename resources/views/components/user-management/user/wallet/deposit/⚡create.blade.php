...
new class extends Component
{
    ...
    #[On('panels.administrator.user-management.user.wallet.deposit.create.assign-data')]
    public function assignData(): void
    {
        ...
        Flux::modal('user-management.user.wallet.deposit.create')->show();
    }
...
<flux:modal name="user-management.user.wallet.deposit.create" flyout position="right" class="space-y-6">
    <div>
