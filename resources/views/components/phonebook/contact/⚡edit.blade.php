...
new class extends Component
{
    ...
    public function assignData(int $contact): void
    {
        ...
        Flux::modal('phonebook.contact.edit')->show();
    }
    ...
    public function save(): void
    {
        ...
        Flux::modals()->close();
        Flux::toast(__('general.contact_updated'));
    }
};
?>

<flux:modal name="phonebook.contact.edit" flyout position="right" class="md:w-96 space-y-6">
    <div>
        <flux:heading size="lg">{{ __('actions.edit') }} {{ __('general.contact') }}</flux:heading>
